...
*Note: these values are a bit higher than in an earlier version due to a change in the way the scores are normalized. We'll be updating the paper shortly.*
